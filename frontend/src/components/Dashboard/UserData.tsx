...
import FetchPlaylist from './FetchPlaylist';
    const UserData: React.FC<UserDataProps> = ({data}) => {
        return (<>
            <div className="container-md bg-secondary-subtle border border-dark d-flex flex-row mb-3 text-align-left">
                <div className='p-2'>
                <img
                ...
                <div className = "p-1 ms-2">
                    <p className='primary-text mt-1 mb-0'>{data.display_name} <span className='secondary-text'>({data.id})</span></p>
